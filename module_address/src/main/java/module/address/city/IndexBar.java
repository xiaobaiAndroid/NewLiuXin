...
public class IndexBar extends View {
    ...
    private List<CitySuspension> mSourceDatas;//Adapter的数据源
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPressedBackground = context.getResources().getColor(module.common.R.color.cl_f1f1f1);//默认按下是纯黑色
        ...
        mPaint.setColor(context.getResources().getColor(module.common.R.color.cl_13b5b1));
        ...
        setmOnIndexPressedListener(new onIndexPressedListener() {
            ...
            public void onIndexPressed(int index, String text) {
                ...
                if (mLayoutManager != null) {
                    ...
                    if (position != -1) {
                        LogUtils.INSTANCE.printI("bzf","position="+position);
                        if(position==1){
                            position = 0;
                        }
    ...
    public IndexBar setmSourceDatas(List<CitySuspension> mSourceDatas) {
    ...
    private int getPosByTag(String tag) {
        ...
        for (int i = 0; i < mSourceDatas.size(); i++) {
            if (tag.equals(mSourceDatas.get(i).getBaseIndexTag())) {
                LogUtils.INSTANCE.printI("bzf","getPosByTag---position="+i);
