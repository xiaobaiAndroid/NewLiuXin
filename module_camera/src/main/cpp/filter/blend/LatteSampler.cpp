...
#include "LatteSampler.h"

void LatteSampler::init() {
    BaseFilterSampler::init();
    mCurveTexture = new TextureProxy(GL_TEXTURE1);
}

string LatteSampler::getFragSrc() {
...
void LatteSampler::setFilterImage(vector<NativeImage *> nativeImages) {
