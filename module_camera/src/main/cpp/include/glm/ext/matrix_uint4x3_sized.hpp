...
namespace glm
{
	...
	/// 8 bit unsigned integer 4x3 renderer.matrix.
	///
	/// @see ext_matrix_uint4x3_sized
	typedef mat<4, 3, uint8, defaultp>				u8mat4x3;

	/// 16 bit unsigned integer 4x3 renderer.matrix.
	///
	/// @see ext_matrix_uint4x3_sized
	typedef mat<4, 3, uint16, defaultp>				u16mat4x3;

	/// 32 bit unsigned integer 4x3 renderer.matrix.
	///
	/// @see ext_matrix_uint4x3_sized
	typedef mat<4, 3, uint32, defaultp>				u32mat4x3;

	/// 64 bit unsigned integer 4x3 renderer.matrix.
	///
	/// @see ext_matrix_uint4x3_sized
