...
namespace glm
{
	...
	/// 8 bit unsigned integer 2x3 renderer.matrix.
	///
	/// @see ext_matrix_uint2x3_sized
	typedef mat<2, 3, uint8, defaultp>				u8mat2x3;

	/// 16 bit unsigned integer 2x3 renderer.matrix.
	///
	/// @see ext_matrix_uint2x3_sized
	typedef mat<2, 3, uint16, defaultp>				u16mat2x3;

	/// 32 bit unsigned integer 2x3 renderer.matrix.
	///
	/// @see ext_matrix_uint2x3_sized
	typedef mat<2, 3, uint32, defaultp>				u32mat2x3;

	/// 64 bit unsigned integer 2x3 renderer.matrix.
	///
	/// @see ext_matrix_uint2x3_sized
