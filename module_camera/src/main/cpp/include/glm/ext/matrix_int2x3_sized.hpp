...
namespace glm
{
	...
	/// 8 bit signed integer 2x3 renderer.matrix.
	///
	/// @see ext_matrix_int2x3_sized
	typedef mat<2, 3, int8, defaultp>				i8mat2x3;

	/// 16 bit signed integer 2x3 renderer.matrix.
	///
	/// @see ext_matrix_int2x3_sized
	typedef mat<2, 3, int16, defaultp>				i16mat2x3;

	/// 32 bit signed integer 2x3 renderer.matrix.
	///
	/// @see ext_matrix_int2x3_sized
	typedef mat<2, 3, int32, defaultp>				i32mat2x3;

	/// 64 bit signed integer 2x3 renderer.matrix.
	///
	/// @see ext_matrix_int2x3_sized
