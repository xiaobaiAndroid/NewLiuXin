...
namespace glm
{
	...
	/// 8 bit signed integer 2x4 renderer.matrix.
	///
	/// @see ext_matrix_int2x4_sized
	typedef mat<2, 4, int8, defaultp>				i8mat2x4;

	/// 16 bit signed integer 2x4 renderer.matrix.
	///
	/// @see ext_matrix_int2x4_sized
	typedef mat<2, 4, int16, defaultp>				i16mat2x4;

	/// 32 bit signed integer 2x4 renderer.matrix.
	///
	/// @see ext_matrix_int2x4_sized
	typedef mat<2, 4, int32, defaultp>				i32mat2x4;

	/// 64 bit signed integer 2x4 renderer.matrix.
	///
	/// @see ext_matrix_int2x4_sized
