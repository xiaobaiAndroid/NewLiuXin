...
namespace glm
{
	...
	/// Builds a rotation 4 * 4 renderer.matrix created from a normalized axis and an angle.
	///
	/// @param m Input renderer.matrix multiplied by this rotation renderer.matrix.
	/// @param angle Rotation angle expressed in radians.
	/// @param axis Rotation axis, must be normalized.
	/// @tparam T Value type used to build the renderer.matrix. Currently supported: half (not recommended), float or double.
	///
