...
public class MyPlayerControlView extends FrameLayout {
  ...
  /**
   * @deprecated Register a {@link MyPlayerView.ControllerVisibilityListener} via {@link
   *     MyPlayerView#setControllerVisibilityListener(MyPlayerView.ControllerVisibilityListener)}
   *     instead. Using {@link MyPlayerControlView} as a standalone class without {@link
   *     MyPlayerView} is deprecated.
   */
  @Deprecated
  ...
  /**
   * @deprecated Register a {@link MyPlayerView.FullscreenButtonClickListener} via {@link
   *     MyPlayerView#setFullscreenButtonClickListener(MyPlayerView.FullscreenButtonClickListener)}
   *     instead. Using {@link MyPlayerControlView} as a standalone class without {@link
   *     MyPlayerView} is deprecated.
   */
  @Deprecated
  ...
  public MyPlayerControlView(
    ...
    int controllerLayoutId = R.layout.my_player_control_view;
      ...
      TypedArray a =
              context
                      ...
                      .obtainStyledAttributes(
                              playbackAttrs,
                              R.styleable.MyPlayerControlView,
                              defStyleAttr,
                              /* defStyleRes= */ 0);
      try {
        controllerLayoutId =
                a.getResourceId(
                        R.styleable.MyPlayerControlView_controller_layout_id, controllerLayoutId);
        showTimeoutMs = a.getInt(R.styleable.MyPlayerControlView_show_timeout, showTimeoutMs);
        repeatToggleModes = getRepeatToggleModes(a, repeatToggleModes);
        showRewindButton =
                a.getBoolean(R.styleable.MyPlayerControlView_show_rewind_button, showRewindButton);
        showFastForwardButton =
                a.getBoolean(
                        R.styleable.MyPlayerControlView_show_fastforward_button, showFastForwardButton);
        showPreviousButton =
                a.getBoolean(
                        R.styleable.MyPlayerControlView_show_previous_button, showPreviousButton);
        showNextButton =
                a.getBoolean(R.styleable.MyPlayerControlView_show_next_button, showNextButton);
        showShuffleButton =
                a.getBoolean(
                        R.styleable.MyPlayerControlView_show_shuffle_button, showShuffleButton);
        showSubtitleButton =
                a.getBoolean(
                        R.styleable.MyPlayerControlView_show_subtitle_button, showSubtitleButton);
        showVrButton =
                a.getBoolean(R.styleable.MyPlayerControlView_show_vr_button, showVrButton);
        setTimeBarMinUpdateInterval(
                a.getInt(
                        R.styleable.MyPlayerControlView_time_bar_min_update_interval,
                        timeBarMinUpdateIntervalMs));
        animationEnabled =
                a.getBoolean(R.styleable.MyPlayerControlView_animation_enabled, animationEnabled);
      } finally {
        a.recycle();
      }
    }
...
//    }
    ...
    controlViewLayoutManager = new MyPlayerControlViewLayoutManager(this);
    ...
    settingsView =
            (RecyclerView)
                    LayoutInflater.from(context)
                            .inflate(R.layout.my_settings_list, /* root= */ null);
  ...
  private void updateSettingsWindowSize() {
    settingsView.measure(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);
  ...
  private static @RepeatModeUtil.RepeatToggleModes int getRepeatToggleModes(
    ...
    return a.getInt(R.styleable.MyPlayerControlView_repeat_toggle_modes, defaultValue);
  }
  ...
  private final class ComponentListener
    ...
    public void onClick(View view) {
      @Nullable Player player = MyPlayerControlView.this.player;
      if (player == null) {
        return;
      }
      controlViewLayoutManager.resetHideCallbacks();
    ...
    public SettingViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View v =
              LayoutInflater.from(getContext())
                      .inflate(R.layout.my_settings_list_item, parent, /* attachToRoot= */ false);
  ...
  private final class PlaybackSpeedAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
    ...
    public SubSettingViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View v =
              LayoutInflater.from(getContext())
                      .inflate(
                              R.layout.my_sub_settings_list_item, parent, /* attachToRoot= */ false);
  ...
  public void setShowDurationView(boolean isShow){
    if(isShow){
  ...
  private void setShowSettingsView(boolean isShow) {
    if(isShow){
