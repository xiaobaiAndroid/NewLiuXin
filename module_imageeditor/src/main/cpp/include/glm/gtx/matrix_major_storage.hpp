...
///
/// Build matrices with specific renderer.matrix order, row or column
...
namespace glm
{
	...
	//! Build a row major renderer.matrix from row vectors.
	...
	//! Build a row major renderer.matrix from other renderer.matrix.
	//! From GLM_GTX_matrix_major_storage extension.
	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<2, 2, T, Q> rowMajor2(
		mat<2, 2, T, Q> const& m);
	...
	//! Build a column major renderer.matrix from column vectors.
	//! From GLM_GTX_matrix_major_storage extension.
	template<typename T, qualifier Q>
	...
	//! Build a column major renderer.matrix from other renderer.matrix.
	//! From GLM_GTX_matrix_major_storage extension.
	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<2, 2, T, Q> colMajor2(
		mat<2, 2, T, Q> const& m);
