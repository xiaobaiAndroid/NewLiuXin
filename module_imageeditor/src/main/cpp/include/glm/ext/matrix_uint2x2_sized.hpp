...
namespace glm
{
	...
	/// 8 bit unsigned integer 2x2 renderer.matrix.
	///
	/// @see ext_matrix_uint2x2_sized
	typedef mat<2, 2, uint8, defaultp>				u8mat2x2;

	/// 16 bit unsigned integer 2x2 renderer.matrix.
	///
	/// @see ext_matrix_uint2x2_sized
	typedef mat<2, 2, uint16, defaultp>				u16mat2x2;

	/// 32 bit unsigned integer 2x2 renderer.matrix.
	///
	/// @see ext_matrix_uint2x2_sized
	typedef mat<2, 2, uint32, defaultp>				u32mat2x2;

	/// 64 bit unsigned integer 2x2 renderer.matrix.
	///
	/// @see ext_matrix_uint2x2_sized
