...
namespace glm
{
	...
	/// 8 bit signed integer 2x2 renderer.matrix.
	///
	/// @see ext_matrix_int2x2_sized
	typedef mat<2, 2, int8, defaultp>				i8mat2x2;

	/// 16 bit signed integer 2x2 renderer.matrix.
	///
	/// @see ext_matrix_int2x2_sized
	typedef mat<2, 2, int16, defaultp>				i16mat2x2;

	/// 32 bit signed integer 2x2 renderer.matrix.
	///
	/// @see ext_matrix_int2x2_sized
	typedef mat<2, 2, int32, defaultp>				i32mat2x2;

	/// 64 bit signed integer 2x2 renderer.matrix.
	///
	/// @see ext_matrix_int2x2_sized
