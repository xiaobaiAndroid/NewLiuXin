...
namespace glm
{
	...
	/// @param model Specifies the current modelview renderer.matrix
	/// @param proj Specifies the current projection renderer.matrix
	...
	/// @param model Specifies the modelview renderer.matrix
	/// @param proj Specifies the projection renderer.matrix
